...
const rename = require('gulp-rename') // load gulp-rename our js filter
...
gulp.task('scripts', function () {
  return gulp.src('js/*js') // setting the source files for gulp to work with
    .pipe(concat('main.js')) // running concat on all the files directly inside js folder with extension .js
    .pipe(gulp.dest('js.dev')) // save the concatenated file into the dev folder
    .pipe(rename('main.min.js')) // pipe the concatenated file and rename it to main.min.js
